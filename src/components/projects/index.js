    ...
    return(
        <div className="m-auto mt-[1rem] pt-[1rem] px-4 rounded-[1.5rem] bg-white opacity-50 w-[90%] ">
            <div className="flex   border-b-[1.5px]">
                <img className="w-[10.3rem] rounded-lg h-[9rem] bg-[orange]" src={connectImg} alt="project Pic"></img>
            ...
            <div className="flex  my-4 border-b-[1.5px]">
                <img className="w-[11rem] rounded-lg h-[9rem] bg-black" src={tttImg} alt="project Pic"></img>
                <div className="mx-4 mb-7 w-[100%]">
