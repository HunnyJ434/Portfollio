...
function NavBurger(props) {
  ...
  const navStyle = {
    ...
    return !props.trigger ? (
      <div className="w-[7rem] h-[20rem] fixed top-0 right-0 z-[9999]  flex flex-col">
